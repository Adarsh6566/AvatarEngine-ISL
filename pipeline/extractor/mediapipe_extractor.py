...
def _dummy_stream(video_path: Path, fps: float, frame_count: int, space: Space) -> SkeletonStreamDict:
    ...
    for i in range(n):
        ...
        joints["lThumb3"] = (lx + 0.09, ly - 0.16, lz + 0.10, 0.9)
        joints["lIndex1"] = (lx + 0.04, ly - 0.25, lz + 0.10, 0.9)
        joints["lIndex2"] = (lx + 0.06, ly - 0.28, lz + 0.11, 0.9)
        joints["lIndex3"] = (lx + 0.08, ly - 0.31, lz + 0.12, 0.9)
        joints["lIndex4"] = (lx + 0.10, ly - 0.34, lz + 0.13, 0.9)
        joints["lMiddle1"] = (lx + 0.02, ly - 0.26, lz + 0.10, 0.9)
        joints["lMiddle2"] = (lx + 0.03, ly - 0.29, lz + 0.11, 0.9)
        joints["lMiddle3"] = (lx + 0.04, ly - 0.32, lz + 0.12, 0.9)
        joints["lMiddle4"] = (lx + 0.05, ly - 0.35, lz + 0.13, 0.9)
        joints["lRing1"] = (lx + 0.00, ly - 0.25, lz + 0.09, 0.9)
        joints["lRing2"] = (lx + 0.01, ly - 0.27, lz + 0.10, 0.9)
        joints["lRing3"] = (lx + 0.02, ly - 0.29, lz + 0.11, 0.9)
        joints["lRing4"] = (lx + 0.03, ly - 0.31, lz + 0.12, 0.9)
        joints["lPinky1"] = (lx - 0.02, ly - 0.23, lz + 0.08, 0.9)
        joints["lPinky2"] = (lx - 0.03, ly - 0.25, lz + 0.09, 0.9)
        joints["lPinky3"] = (lx - 0.04, ly - 0.27, lz + 0.10, 0.9)
        joints["lPinky4"] = (lx - 0.05, ly - 0.29, lz + 0.11, 0.9)
        ...
        joints["rThumb3"] = (rx - 0.09, ry - 0.16, rz + 0.10, 0.9)
        joints["rIndex1"] = (rx - 0.04, ry - 0.25, rz + 0.10, 0.9)
        joints["rIndex2"] = (rx - 0.06, ry - 0.28, rz + 0.11, 0.9)
        joints["rIndex3"] = (rx - 0.08, ry - 0.31, rz + 0.12, 0.9)
        joints["rIndex4"] = (rx - 0.10, ry - 0.34, rz + 0.13, 0.9)
        joints["rMiddle1"] = (rx - 0.02, ry - 0.26, rz + 0.10, 0.9)
        joints["rMiddle2"] = (rx - 0.03, ry - 0.29, rz + 0.11, 0.9)
        joints["rMiddle3"] = (rx - 0.04, ry - 0.32, rz + 0.12, 0.9)
        joints["rMiddle4"] = (rx - 0.05, ry - 0.35, rz + 0.13, 0.9)
        joints["rRing1"] = (rx - 0.00, ry - 0.25, rz + 0.09, 0.9)
        joints["rRing2"] = (rx - 0.01, ry - 0.27, rz + 0.10, 0.9)
        joints["rRing3"] = (rx - 0.02, ry - 0.29, rz + 0.11, 0.9)
        joints["rRing4"] = (rx - 0.03, ry - 0.31, rz + 0.12, 0.9)
        joints["rPinky1"] = (rx + 0.02, ry - 0.23, rz + 0.08, 0.9)
        joints["rPinky2"] = (rx + 0.03, ry - 0.25, rz + 0.09, 0.9)
        joints["rPinky3"] = (rx + 0.04, ry - 0.27, rz + 0.10, 0.9)
        joints["rPinky4"] = (rx + 0.05, ry - 0.29, rz + 0.11, 0.9)
                    ...
                    for side, det in [("l", assigned["l"]), ("r", assigned["r"])]:
                        ...
                        if use_world and anchor is not None and idx_hand is not None:
                            ...
                            def hp(i):
                                ...
                                return (float(p.x), float(p.y), float(p.z), 1.0)
                        try:
                            # 4 joints/finger: consecutive HandLandmarker points
                            # (MCP, PIP, DIP, TIP) so 1→2 drives the proximal bone,
                            # 2→3 the intermediate, 3→4 the distal. Thumb has 3 points
                            # (MCP, IP, TIP) → proximal + distal.
                            joints[f"{prefix}Hand"] = hp(0)
                            joints[f"{prefix}Thumb1"] = hp(2)
                            joints[f"{prefix}Thumb2"] = hp(3)
                            joints[f"{prefix}Thumb3"] = hp(4)
                            joints[f"{prefix}Index1"] = hp(5)
                            joints[f"{prefix}Index2"] = hp(6)
                            joints[f"{prefix}Index3"] = hp(7)
                            joints[f"{prefix}Index4"] = hp(8)
                            joints[f"{prefix}Middle1"] = hp(9)
                            joints[f"{prefix}Middle2"] = hp(10)
                            joints[f"{prefix}Middle3"] = hp(11)
                            joints[f"{prefix}Middle4"] = hp(12)
                            joints[f"{prefix}Ring1"] = hp(13)
                            joints[f"{prefix}Ring2"] = hp(14)
                            joints[f"{prefix}Ring3"] = hp(15)
                            joints[f"{prefix}Ring4"] = hp(16)
                            joints[f"{prefix}Pinky1"] = hp(17)
                            joints[f"{prefix}Pinky2"] = hp(18)
                            joints[f"{prefix}Pinky3"] = hp(19)
                            joints[f"{prefix}Pinky4"] = hp(20)
                        except Exception:
                            pass
                    # log swap correction
                    if len(detected) == 2:
